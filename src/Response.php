...
abstract class Xapp_Rpc_Response
{
    ...
    /**
     * returns status code set in class option or if php >= 5.4 returns by php´s native http_response_code() method
     *
     * @error 14519
     * @return int
     */
    public function getStatusCode()
    {
        if(function_exists('http_response_code'))
        {
            ...
            return xapp_get_option(self::STATUS_CODE, $this);
        }
    }
    ...
    {
        return xapp_array_get($this->_data, $key, xapp_default($default));
    }

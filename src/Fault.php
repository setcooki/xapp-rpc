...
class Xapp_Rpc_Fault extends ErrorException
{
     ...
     * @param int $code expects error code
     * @param int $severity expects severity flag
     * @param null|mixed $data expects optional additional data
     * @return Xapp_Rpc_Fault
     */
    public static function create($message, $code, $severity = XAPP_ERROR_IGNORE, $data = null)
    {
     ...
     */
    public static function t($message, $code, $severity = XAPP_ERROR_IGNORE, $data = null)
    {
        $fault = null;
    ...
    public function getData($key = null, $default = null)
    {
        if($key !== null)
        {
            return ($this->hasData($key)) ? xapp_array_get($this->_data, $key) : xapp_default($default);
        }else{
            return $this->_data;
        }
    }
